...
int        port     = 1884;
const char topic1[]  = "student/Qian(Ashley)/Environment data/temperature";
const char topic2[]  = "student/Qian(Ashley)/Environment data/humidity";
const char topic3[]  = "student/Qian(Ashley)/Environment data/illumination";
const char topic4[]  = "student/Qian(Ashley)/Environment data/soil moisture";
const char topic5[]  = "student/Qian(Ashley)/Trigger/Temperature";
const char topic6[]  = "student/Qian(Ashley)/Trigger/Humidity";
const char topic7[]  = "student/Qian(Ashley)/Trigger/Illumination";
const char topic8[]  = "student/Qian(Ashley)/Trigger/Soil Mosture";
const char topic9[]  = "student/Qian(Ashley)/Actuation system/air condition";
const char topic10[]  = "student/Qian(Ashley)/Actuation system/fan";
const char topic11[]  = "student/Qian(Ashley)/Actuation system/LED Matrix";
const char topic12[]  = "student/Qian(Ashley)/Actuation system/Pump";
const char topic13[]  = "student/Qian(Ashley)/LED indicator/temperature indicator";
const char topic14[]  = "student/Qian(Ashley)/LED indicator/humidity indicator";
const char topic15[]  = "student/Qian(Ashley)/LED indicator/illumination indicator";
...
void sendMQTT(){
    ...
    int Triggerlight=digitalRead(2);
    if(Triggerlight = 1){
      mqttClient.print("ON");
    }else{
      mqttClient.print("OFF");
...
void loop(){
    ...
    // Trigger Function with Actuation
    temperature_Trigger();
    humidity_Trigger();
    light_Trigger();
    pump_Trigger(); 
